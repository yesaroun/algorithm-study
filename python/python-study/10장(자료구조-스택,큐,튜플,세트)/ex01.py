...
#               데이터를 관리하는 것, 대용량일수록 빨리 저장하고 빨리 검색하고,
#               메모리를 최대한 효율적으로 사용하면서 유저들에게 실행결과를 빨리 돌려주는 방법
...
result = []
# _ 라는 기호는 파이썬에서 상당히 많이 사용되는 기호인데, for문을 루프시킬때,
# 루프변수에 값을 사용하지 않을때, _ 로 할당받는 것이다.
