...
# 진상위 집합의 개념 : SET2집합이 SET1 집합에 포함되지만 서로 집합은 동일하지 않는 집합을 의미한다.
SET1 = {10, 20, 30, 40, 50, 60}
SET2 = {10, 20, 30}
# 연산자를 이용한 방법
print("SET2는 SET1에 부분 집합인가? : ", SET1 > SET2)
# issubset()을 이용한 방법
print("SET2는 SET1에 부분 집합인가? : ", SET1.issuperset(SET2))

# 데이터값이 집합에 포함되어 있는지 확인하는 방법
...
# 방법 : 연산은 &을 사용하거냐 intersection() 이용한다.
SET1 = {10, 20, 30, 40, 50, 60}
SET2 = {10, 20, 30}
print("교집합 : ", SET1 & SET2)
