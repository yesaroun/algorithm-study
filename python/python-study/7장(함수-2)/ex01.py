...
n = 100
# id()함수는 매개변수 값으로 객체를 받아서 그 객체의 고유한 주소값을 반환해주는 함수이다.
print("호출 전 n의 주소(id): ", id(n))
print("호출 전 n의 값: ", n)
x = change(n)
print("호출 후 x의 값: ", x)
print("호출 후 x의 주소값: ", id(x))
print("호출 후의 n의 값: ", n)
print("호출 후의 n의 주소값: ", id(n))

#--==>>
'''
호출 전 n의 주소(id):  4298708432
호출 전 n의 값:  100
change()내의 num 값 :  110
change()내의 num의 주소(id) :  4298708752
호출 후 x의 값:  110
호출 후 x의 주소값:  4298708752
호출 후의 n의 값:  100
호출 후의 n의 주소값:  4298708432
'''